...
local preview_win_position = nil
local current_win_position = nil
...
local create_hologram = function(filepath)
	hologram_image = require("hologram.image"):new(filepath, {})
	hologram_image.display(hologram_row, hologram_col, vim.api.nvim_get_current_buf(), {})
...
M.buffer_previewer_maker = function(filepath, bufnr, opts)
	...
	local filetype = file_extension(filepath)
